...
class Movies:
	def __init__(self, notifications=True):
		self.list = []
		control.homeWindow.clearProperty('thor.preResolved_nextUrl') # helps solve issue where "onPlaybackStopped()" callback fails to happen
		...
		self.top100_link = 'https://www.imdb.com/search/title?title_type=feature&groups=top_100&count=%s&start=1' % self.page_limit
		self.top100_classic_link = 'https://www.imdb.com/list/ls050429174/?view=detail&sort=alpha,asc&title_type=movie,tvMovie&count=%s&start=1' % self.page_limit
		self.top100_classic_comedies_link = 'https://www.imdb.com/list/ls000551766/?view=detail&sort=alpha,asc&title_type=movie,tvMovie&count=%s&start=1' % self.page_limit		
		self.top300_comedies_link = 'https://www.imdb.com/list/ls003935197/?view=detail&sort=user_rating,desc&title_type=movie,tvMovie&count=%s&start=1' % self.page_limit				
		self.top250_link = 'https://www.imdb.com/search/title?title_type=feature&groups=top_250&count=%s&start=1' % self.page_limit
		self.top1000_link = 'https://www.imdb.com/search/title?title_type=feature&groups=top_1000&count=%s&start=1' % self.page_limit
		...
		self.bestdirector_link = 'https://www.imdb.com/search/title?title_type=feature&groups=best_director_winner&sort=user_rating,desc&count=%s&start=1' % self.page_limit
		self.national_film_board_link = 'https://www.imdb.com/search/title?title_type=feature&groups=national_film_preservation_board_winner&sort=user_rating,desc&count=%s&start=1' % self.page_limit
		self.dreamworks_pictures_link = 'https://www.imdb.com/search/title?title_type=feature&companies=dreamworks&count=%s&start=1' % self.page_limit
		self.fox_pictures_link = 'https://www.imdb.com/search/title?title_type=feature&companies=fox&count=%s&start=1' % self.page_limit
		self.paramount_pictures_link = 'https://www.imdb.com/search/title?title_type=feature&companies=paramount&count=%s&start=1' % self.page_limit
		self.mgm_pictures_link = 'https://www.imdb.com/search/title?title_type=feature&companies=mgm&count=%s&start=1' % self.page_limit
		self.universal_pictures_link = 'https://www.imdb.com/search/title?title_type=feature&companies=universal&count=%s&start=1' % self.page_limit
		self.sony_pictures_link = 'https://www.imdb.com/search/title?title_type=feature&companies=sony&count=%s&start=1' % self.page_limit
		self.warnerbrothers_pictures = 'https://www.imdb.com/search/title?title_type=feature&companies=warner&count=%s&start=1' % self.page_limit
		self.amazon_prime_link = 'https://www.imdb.com/search/title?title_type=feature&online_availability=US%2Ftoday%2FAmazon%2Fsubs'
		self.disney_pictures_link = 'https://www.imdb.com/search/title?user_rating=1.0,10.0&companies=disney&count=%s&start=1' % self.page_limit
		self.family_movies_link = 'https://www.imdb.com/search/title/?title_type=feature&genres=family&count=%s&start=1' % self.page_limit
		self.classic_comedy_link = 'https://www.imdb.com/search/title/?title_type=feature&release_date=1940-01-01,1970-12-31&genres=comedy&languages=en&adult=include&count=%s&start=1' % self.page_limit 			
		self.classic_movies_link = 'https://www.imdb.com/search/title?title_type=feature&release_date=1900-01-01,1993-12-31&count=%s&start=1' % self.page_limit
		self.classic_horror_link = 'https://www.imdb.com/search/title?title_type=feature&release_date=1900-01-01,1993-12-31&genres=horror&count=%s&start=1' % self.page_limit
		self.classic_fantasy_link = 'https://www.imdb.com/search/title?title_type=feature&release_date=1900-01-01,1993-12-31&genres=fantasy&count=%s&start=1' % self.page_limit
		self.classic_romance_link = 'https://www.imdb.com/search/title?title_type=feature&release_date=1900-01-01,1993-12-31&genres=romance&count=%s&start=1' % self.page_limit
		self.classic_western_link = 'https://www.imdb.com/search/title?title_type=feature&release_date=1900-01-01,1993-12-31&genres=western&count=%s&start=1' % self.page_limit
		self.classic_annimation_link = 'https://www.imdb.com/search/title?title_type=feature&release_date=1900-01-01,1993-12-31&genres=animation&count=%s&start=1' % self.page_limit
		self.classic_war_link = 'https://www.imdb.com/search/title?title_type=feature&release_date=1900-01-01,1993-12-31&genres=war&count=%s&start=1' % self.page_limit
		self.classic_scifi_link = 'https://www.imdb.com/search/title?title_type=feature&release_date=1900-01-01,1993-12-31&genres=sci_fi&count=%s&start=1' % self.page_limit
		self.thirties_link = 'https://www.imdb.com/search/title?title_type=feature&release_date=1930-01-01,1939-12-31&count=%s&start=1' % self.page_limit
		self.forties_link = 'https://www.imdb.com/search/title?title_type=feature&release_date=1940-01-01,1949-12-31&count=%s&start=1' % self.page_limit
		self.fifties_link = 'https://www.imdb.com/search/title?title_type=feature&release_date=1950-01-01,1959-12-31&count=%s&start=1' % self.page_limit
		self.sixties_link = 'https://www.imdb.com/search/title?title_type=feature&release_date=1960-01-01,1969-12-31&count=%s&start=1' % self.page_limit
		self.seventies_link = 'https://www.imdb.com/search/title?title_type=feature&release_date=1970-01-01,1979-12-31&count=%s&start=1' % self.page_limit
		self.eighties_link = 'https://www.imdb.com/search/title?title_type=feature&release_date=1980-01-01,1989-12-31&count=%s&start=1' % self.page_limit
		self.nineties_link = 'https://www.imdb.com/search/title?title_type=feature&release_date=1990-01-01,1999-12-31&count=%s&start=1' % self.page_limit
		self.thousands_link = 'https://www.imdb.com/search/title?title_type=feature&release_date=2000-01-01,2010-12-31&count=%s&start=1' % self.page_limit
		self.twenty10_link = 'https://www.imdb.com/search/title?title_type=feature&release_date=2010-01-01,2019-12-31&count=%s&start=1' % self.page_limit		
		self.twenty20_link = 'https://www.imdb.com/search/title?title_type=feature&release_date=2020-01-01,2029-12-31&count=%s&start=1' % self.page_limit		


		######HALLOWEN########
		self.halloween_imdb_link = 'https://www.imdb.com/list/ls066334100/?sort=user_rating,desc&st_dt=&mode=detail&page=1&count=%s&start=1' % self.page_limit
		self.halloween_top_100_link = 'https://www.imdb.com/list/ls000091321/?sort=user_rating,desc&st_dt=&mode=detail&page=1&count=%s&start=1' % self.page_limit
		self.halloween_best_link = 'https://www.imdb.com/list/ls052042029/?sort=user_rating,desc&st_dt=&mode=detail&page=1&count=%s&start=1' % self.page_limit
		self.halloween_great_link = 'https://www.imdb.com/list/ls050722485/?sort=user_rating,desc&st_dt=&mode=detail&page=1&count=%s&start=1' % self.page_limit
		#######HOLIDAY########
		self.top50_holiday_link = 'https://www.imdb.com/list/ls003988974/?sort=user_rating,desc&st_dt=&mode=detail&page=1&count=%s&start=1' % self.page_limit
		self.best_holiday_link = 'https://www.imdb.com/list/ls053245198/?sort=user_rating,desc&st_dt=&mode=detail&page=1&count=%s&start=1' % self.page_limit		
	...
	def unfinishedManager(self):
		try:
			...
			del window
			if selected_items:
				refresh = 'plugin.video.thor' in control.infoLabel('Container.PluginName')
	...
	def search_new(self):
		...
		control.closeAll()
		control.execute('ActivateWindow(Videos,plugin://plugin.video.thor/?action=movies&url=%s,return)' % (quote_plus(url)))
	...
	def person(self):
		...
		control.closeAll()
		control.execute('ActivateWindow(Videos,plugin://plugin.video.thor/?action=moviePersons&url=%s,return)' % (quote_plus(url)))
