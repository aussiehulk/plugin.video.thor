...
LOGDEBUG = xbmc.LOGDEBUG #0  only prints when thor logging set to "Debug" (LOGINFO ads to list if Leia(18))
# ###--from here down methods print when Thor logging set to "Normal".
LOGINFO = xbmc.LOGINFO #1 (doesn't print unless Thor logging set to "Debug" in Leia(18))
