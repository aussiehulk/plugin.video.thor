...
playAction = xbmcaddon.Addon('plugin.video.thor').getSetting('hosts.mode')
autoPlay = 'true' if playAction == '2' else ''
control.homeWindow.setProperty('plugin.video.thor.autoPlay', autoPlay)
...
from resources.lib.indexers import thorstreams
